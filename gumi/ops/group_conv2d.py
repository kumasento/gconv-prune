  ...
  """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.ind_out = self.create_indices_parameter(self.out_planes, indices=ind_out)
    ...
    @staticmethod
    def get_num_groups(in_channels, out_channels, max_channels_per_group, groups=1):
    ...
    @staticmethod
    def groupable(in_channels, out_channels, groups=1, max_channels_per_group=None):
        ...
        if max_channels_per_group:  # overrides groups
            try:
                GroupConv2d.get_num_groups(
                    in_channels, out_channels, max_channels_per_group
                )
                return True
            ...
            return (
                groups > 1 and in_channels % groups == 0 and out_channels % groups == 0
            )
...
class SparseGroupConv2d(nn.Module):
    ...
    def update_weight(self, W, threshold=None):
        ...
        self.weight.data = torch.sparse.FloatTensor(
            i, v, torch.Size(W.shape)
        ).coalesce()
