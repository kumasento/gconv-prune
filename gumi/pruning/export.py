...
class GroupExporter(object):
    ...
    def export_to_std_conv2d(child, mm=False):
        ...
        conv = nn.Conv2d(child.in_channels,
                         child.out_channels,
                         child.kernel_size,
                         stride=child.stride,
            ...
            for child_name, child in mod.named_children():
                ...
                if isinstance(child, MaskConv2d):
                    if child.G > 1:
                        ...
                        if (sparse and child.kernel_size == 1 and
                                child.padding[0] == 0 and
                                child.stride[0] == 1 and
                                child.in_channels >= min_sparse_channels and
                                child.out_channels >= min_sparse_channels):
                            logging.info(
