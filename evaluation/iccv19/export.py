...
parser.add_argument(
    "--onnx", action="store_true", default=False, help="Whether to export to ONNX"
)
parser.add_argument("--mm", action="store_true", default=False, help="MM pointwise")
parser.add_argument(
    "--sparse",
    action="store_true",
    default=False,
...
parser.add_argument(
    "--min-sparse-channels", type=int, default=0, help="Min channels to sparsify."
)
parser.add_argument("--val", action="store_true", default=False, help="Validate")
