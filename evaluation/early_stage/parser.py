...
def create_parser(prog=""):
    ...
    parser.add_argument("--mcpg", type=int, default=-1, help="Max channels per group.")
    parser.add_argument(
        "--group-cfg",
        type=str,
        metavar="PATH",
    ...
    # mask
    parser.add_argument(
        "--perm", type=str, default=None, help="Permutation when building MBM mask."
    )
    parser.add_argument(
        "--num-sort-iters", type=int, default=1, help="Number of heuristic iterations."
    )
